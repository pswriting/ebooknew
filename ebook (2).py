...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
🔥 핵심: 컨셉이 목차 전체를 관통해야 한다
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

위에서 만든 "시스템/공식 이름"이 목차의 뼈대가 되어야 함.
각 챕터는 그 시스템의 서로 다른 측면을 다룸.
독자가 "이 시스템을 배우면 나도 된다"고 느끼게.

예시) "3단계 수익 루프" 컨셉이라면:
- PART 1. 왜 99%는 첫 단계에서 탈락하는가
- PART 2. 루프의 핵심, 두 번째 단계의 비밀
- PART 3. 세 번째 단계에서 수익이 폭발하는 이유
- PART 4. 루프를 2배 빠르게 돌리는 방법
- PART 5. 루프가 자동으로 굴러가는 최종 구조

예시) "역전 매트릭스" 컨셉이라면:
- PART 1. 당신이 지금까지 거꾸로 해온 것들
- PART 2. 매트릭스의 첫 번째 축, 시간의 재배치
- PART 3. 두 번째 축, 돈의 흐름을 바꾸는 법
- PART 4. 매트릭스 완성, 두 축이 만나는 지점
- PART 5. 역전이 시작되는 순간

→ 컨셉 키워드가 계속 등장하면서 하나의 스토리를 만든다
...
[도발 + 컨셉]
• "왜 [컨셉]을 모르면 평생 제자리인가"
• "[컨셉]의 첫 번째 원칙을 90%가 무시한다"
• "당신의 [주제]가 실패한 진짜 이유"

[호기심 + 컨셉]
• "[컨셉]이 작동하는 숨겨진 메커니즘"
• "아무도 말 안 해주는 [컨셉]의 두 번째 비밀"
• "[컨셉]으로 3개월 만에 결과가 나온 이유"

[결과 + 컨셉]
• "[컨셉]을 적용한 후 달라진 3가지"
• "월 0에서 월 500, [컨셉]이 만든 차이"

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
🎯 소제목도 컨셉과 연결
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

각 소제목은 해당 챕터의 컨셉을 구체화:
- "[컨셉] 1단계에서 반드시 해야 할 것"
- "이것만 빼도 [컨셉] 효과 2배"
- "[컨셉]을 망치는 치명적 실수 3가지"
- "왜 [컨셉] 없이는 돈을 못 버는가"
...
❌ 컨셉 없이 각 챕터가 따로 노는 목차
❌ 평범하고 무난한 제목
❌ 영어 약자 네이밍 (DIP, CPM 등) - 한글로만
❌ "~의 이해", "~의 기초", "효과적인", "성공적인"
❌ 나침반/지도/열쇠/보물/황금/마법/연금술
❌ 같은 숫자 표현 2번 이상 반복
❌ 비슷한 문장 구조 반복
...
PART 1. [컨셉 키워드 포함된 자극적 제목]
- [컨셉과 연결된 소제목]
- [컨셉과 연결된 소제목]
- [컨셉과 연결된 소제목]

PART 2. [컨셉 키워드 포함된 자극적 제목]
- [소제목]
- [소제목]
- [소제목]

PART 3. [컨셉 키워드 포함된 자극적 제목]
- [소제목]
- [소제목]
- [소제목]

PART 4. [컨셉 키워드 포함된 자극적 제목]
- [소제목]
- [소제목]
- [소제목]

PART 5. [컨셉 키워드 포함된 자극적 제목]
- [소제목]
- [소제목]
- [소제목]

목차만 출력. 컨셉이 목차 전체를 관통하면서 자극적으로."""
...
def generate_outline(topic, persona, pains, gaps=None):
    ...
    prompt = f"""당신은 크몽/클래스101 베스트셀러 전자책 기획자입니다.
목차만 보고 결제 버튼을 누르게 만드세요.

[주제]: {topic}

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
🔥 먼저 이 책만의 고유 컨셉을 만들어라
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

예시) 블로그 수익화 주제라면:
→ "3단계 트래픽 루프" 같은 고유 시스템 이름

예시) 주식 투자 주제라면:
→ "역발상 매매 공식" 같은 고유 시스템 이름
...
• "왜 [컨셉]을 모르면 평생 제자리인가"
• "[컨셉]의 첫 번째 법칙을 90%가 무시한다"
• "아무도 말 안 해주는 [컨셉]의 진짜 비밀"
• "[컨셉]으로 3개월 만에 달라진 이유"
